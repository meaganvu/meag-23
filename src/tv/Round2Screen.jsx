        ...
        <div className="round-main-content">
          <div className="round-instructions-timer-container">
            <div className="round-instructions anonymous-pro-regular">
              ...
              If your partner catches someone spiking your drink then the assassins partner has to drink<br/>
              If you catch your assassin then your assassin has to drink<br/>
              Your targets will never be your partner, but targets are not based on partners, they are still at random<br/>
